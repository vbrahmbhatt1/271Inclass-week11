...
int mainnope()
{
    ...
    cout << endl;
    cout << test->add_word_to_tree("RYRY") << endl;
    cout << test->is_word_in_tree("RYRY") << endl;
    ...
    cout << test->is_word_in_tree("RYRYRY") << endl;
    cout << test->add_word_to_tree("RYRYRY") << endl;
    cout << test->is_word_in_tree("RYRYRY") << endl;
    cout << test->is_word_in_tree("RYRYRY")<<endl;
...
bool test_add_word_to_tree()
{
    BTree *b;
    b = new BTree;
    BTreeNode * temp = b -> Root;
    /**testing adding a word to a null tree.....the path isn't there**/
    b->add_word_to_tree("rrr");
    int counter = 0;
...
/*bool test_add_node()
{
    BTree *b;
    b = new BTree;
    if(b->add_node(b->Root,'r'))
    {

    }
    if(b->Root->Lchild && b->Root->Lchild->Data==NULL)
}
*/
